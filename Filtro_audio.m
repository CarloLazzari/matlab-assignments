...
[xstereo,~]=audioread(filename,[1,numeroCampioni]); %nuova versione da R2016
...
% filtro passa basso? alto? a tre bande?
gLP = 2*B*sinc(2*B.*tempoFiltro-T/2).*rectpuls((tempoFiltro-T/2)/T);
gHP = 1-gLP;
